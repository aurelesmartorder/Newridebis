...
## Correctif microphone iPhone
Cette version inclut bien `netlify/functions/transcribe-audio.js`. Le navigateur envoie des fragments audio encodés en Base64 JSON et la fonction les convertit avant transcription. Un délai maximal empêche l'écran de rester bloqué sur « Analyse de la voix… ».
