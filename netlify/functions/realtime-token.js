      ...
      session: {
        ...
        audio: {
          input: {
            ...
            // (CORRECTIF) Verrouille la langue de transcription sur le français —
            // sans ça, l'API peut mal transcrire ou dériver vers l'anglais,
            // ce qui entraîne ensuite une réponse du modèle dans la mauvaise langue.
